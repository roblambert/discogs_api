...
puts "Their first release listed in the response is #{artist.releases.first.title} which was released on #{artist.releases.first.label}"

# Let's find more information about that first listed release from the artist object...

sleep 2 # Discogs asks that you do not hit the service more than once a second from an IP address!
...
Copyright (c) 2011 Rob Lambert, released under the MIT license
